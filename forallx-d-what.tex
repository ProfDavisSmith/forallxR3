...
\section{Part \thechapcount.\theseccount: Arguments: What is logic?}\refstepcounter{seccount}
\label{s.arguments}
...
\section{Part \thechapcount.\theseccount: Sentences and Propositions}\refstepcounter{seccount}
...
\refstepcounter{chapcount}
\chapter{Part \thechapcount: Types of Arguments}\setcounter{seccount}{1}
\label{s:Valid}
\section{Part \thechapcount.\theseccount: Consequence and validity}\refstepcounter{seccount}
...
\section{Part \thechapcount.\theseccount: Cases and Types of Validity}\refstepcounter{seccount}
...
\section{Part \thechapcount.\theseccount: Formal Validity}\refstepcounter{seccount}
...
\section{Part \thechapcount.\theseccount: Soundness}\refstepcounter{seccount}
...
\section{Part \thechapcount.\theseccount: Deductive vs Inductive Arguments}\refstepcounter{seccount}
...
\section{Part \thechapcount.\theseccount: Necessary truths, necessary falsehoods, and contingency}\refstepcounter{seccount}\label{s.nectruth}
...
\section{Part \thechapcount.\theseccount: Necessary equivalence}\refstepcounter{seccount}
