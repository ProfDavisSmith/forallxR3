...
\section{Part \thechapcount.\theseccount: Symbolizing Identity Statements}\stepcounter{seccount}
...
\end{center}
\section{Part \thechapcount.\theseccount: The Semantics and Rules for Identity}\stepcounter{seccount}
...
\section{Part \thechapcount.\theseccount: The Equivalency Rules in PL are in QL}\stepcounter{seccount}
...
\section{Part \thechapcount.\theseccount: Change of Quantifier (Quantifier Negation)}\label{s.QN}\stepcounter{seccount}
